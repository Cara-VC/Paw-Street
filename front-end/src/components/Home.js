                        ...
                        <Form>
                            <Row>
                                ...
                                <Col xs="2">
                                    ...
                                    <input type="range" className="form-range" id="distance" min="1" max="5" step="1" defaultValue="3"
                                       onChange={()=>{
                                ...
                                <Col xs="2">
                                    ...
                                    <Form.Check id="found"
                                        onChange={() => {setTempFound(document.getElementById("found").checked)}} type="checkbox" label="Found"/>
                                </Col>

                                <Col xs="2">
                                    <Form.Select size="sm" id="time" onChange={() => {setTempTime(document.getElementById("time").value)}}>
